...
public class BrandController {
    ...
    public ModelAndView index(ModelAndView mav) {
        mav.setViewName("brand/index");
        mav.addObject("brands", brandService.findAll());
        return mav;
    }

    @GetMapping(value = UrlRoute.URL_BRAND + "/{field}")
    ...
    @GetMapping(path = UrlRoute.URL_BRAND_NEW)
    ...
    @GetMapping(path = UrlRoute.URL_BRAND_EDIT + "/{id}")
    ...
    private ModelAndView formHandle(BindingResult result, ModelAndView mav, BrandDTO dto, Long id) {
        ...
        mav.setViewName("redirect:" + UrlRoute.URL_BRAND);
        return mav;
    }
